export const rule = [
  ...
  // id
  {
    ...
    schema: {
      type: 'string',
      pattern: 'urn:jiot-spec-v1:thing_model:\\w*:\\w{16}',
      title: '示例: urn:jiot-spec-v1:thing_model:light:xxx-xxxx',
    },
  },
  {
    ...
    schema: {
      type: 'string',
      pattern: 'urn:jiot-spec-v1:function:\\w*:\\w{16}',
      title: '示例: urn:jiot-spec-v1:function:light:xxx-xxxx',
    },
  },
  {
    ...
    schema: {
      type: 'string',
      pattern: 'urn:jiot-spec-v1:event:\\w*:\\w{16}',
      title: '示例: urn:jiot-spec-v1:event:light:xxx-xxxx',
    },
  },
  {
    ...
    schema: {
      type: 'string',
      pattern: 'urn:jiot-spec-v1:model:\\w*:\\w{16}',
      title: '示例: urn:jiot-spec-v1:model:light:xxx-xxxx',
    },
  },
  {
